...
import { propertyCardStyles as s } from "../../style/property/PropertyCardStyle";
import { titleCase } from "../../style/Styles";
    ...
    <div className={s.card}>
      <Link to={`/property/${property._id}`} className={s.link}>
        ...
        <div className={s.content}>
          ...
          <h4 className={s.title}>{titleCase(property.title)}</h4>

          <div className={s.location}>
            <HiLocationMarker className={s.locationIcon} />
            <span className="whitespace-nowrap overflow-hidden text-ellipsis">
              {titleCase(property.area)}, {titleCase(property.city)}
            </span>
          </div>
