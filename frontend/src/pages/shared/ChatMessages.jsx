...
import { chatMessagesStyles as s } from "../../style/Chat&Contact/chatMessageStyle";
                ...
                <div className={s.chatHeaderLeft}>
                  ...
                  <div className={s.avatar}>
                    {getChatPartner(activeChat)?.profilePic ? (
                      <img className={s.avatarImg} src={getChatPartner(activeChat).profilePic} alt="" />
                    ) : (
